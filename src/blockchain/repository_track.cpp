...
//    }
    ...
    state_array repository_track::get_state_array_by_hash(const aux::bytes &chain_id, const sha256_hash &hash) {
    ...
    bool repository_track::delete_state_array_by_hash(const aux::bytes &chain_id, const sha256_hash &hash) {
        return false;
    }
