...
namespace libTAU {
    namespace communication {
        ...
        namespace {
            ...
            // last detection time key suffix
...
//            std::string value(encode.begin(), encode.end());
        ...
        int64_t message_db_impl::get_last_detection_time(const std::pair<dht::public_key, dht::public_key> &key) {
            std::string sKey;
            sKey.insert(sKey.end(), key.first.bytes.begin(), key.first.bytes.end());
            sKey.insert(sKey.end(), key.second.bytes.begin(), key.second.bytes.end());
            sKey.insert(sKey.end(), key_suffix_last_detection_time.begin(), key_suffix_last_detection_time.end());
        ...
        bool message_db_impl::save_last_detection_time(const std::pair<dht::public_key, dht::public_key> &key,
                                                       std::int64_t timestamp) {
            std::string sKey;
            sKey.insert(sKey.end(), key.first.bytes.begin(), key.first.bytes.end());
            sKey.insert(sKey.end(), key.second.bytes.begin(), key.second.bytes.end());
        ...
        bool message_db_impl::delete_last_detection_time(const std::pair<dht::public_key, dht::public_key> &key) {
            std::string sKey;
            sKey.insert(sKey.end(), key.first.bytes.begin(), key.first.bytes.end());
            sKey.insert(sKey.end(), key.second.bytes.begin(), key.second.bytes.end());
            sKey.insert(sKey.end(), key_suffix_last_detection_time.begin(), key_suffix_last_detection_time.end());
        ...
        int64_t message_db_impl::get_last_communication_time(const std::pair<dht::public_key, dht::public_key> &key) {
            std::string sKey;
            sKey.insert(sKey.end(), key.first.bytes.begin(), key.first.bytes.end());
            sKey.insert(sKey.end(), key.second.bytes.begin(), key.second.bytes.end());
        ...
        bool message_db_impl::save_last_communication_time(const std::pair<dht::public_key, dht::public_key> &key,
                                                           std::int64_t timestamp) {
            std::string sKey;
            sKey.insert(sKey.end(), key.first.bytes.begin(), key.first.bytes.end());
            sKey.insert(sKey.end(), key.second.bytes.begin(), key.second.bytes.end());
        ...
        bool message_db_impl::delete_last_communication_time(const std::pair<dht::public_key, dht::public_key> &key) {
            std::string sKey;
            sKey.insert(sKey.end(), key.first.bytes.begin(), key.first.bytes.end());
            sKey.insert(sKey.end(), key.second.bytes.begin(), key.second.bytes.end());
            sKey.insert(sKey.end(), key_suffix_last_communication_time.begin(), key_suffix_last_communication_time.end());
        ...
        aux::bytes message_db_impl::get_levenshtein_array(const std::pair<dht::public_key, dht::public_key> &key) {
            std::string sKey;
            sKey.insert(sKey.end(), key.first.bytes.begin(), key.first.bytes.end());
            sKey.insert(sKey.end(), key.second.bytes.begin(), key.second.bytes.end());
            sKey.insert(sKey.end(), key_suffix_levenshtein_array.begin(), key_suffix_levenshtein_array.end());
        ...
        bool message_db_impl::save_levenshtein_array(const std::pair<dht::public_key, dht::public_key> &key,
            ...
            std::string value(levenshtein_array.begin(), levenshtein_array.end());

            leveldb::Status status = m_leveldb->Put(leveldb::WriteOptions(), sKey, value);
            return status.ok();
        }

        bool message_db_impl::delete_levenshtein_array(const std::pair<dht::public_key, dht::public_key> &key) {
            std::string sKey;
            sKey.insert(sKey.end(), key.first.bytes.begin(), key.first.bytes.end());
            sKey.insert(sKey.end(), key.second.bytes.begin(), key.second.bytes.end());
            sKey.insert(sKey.end(), key_suffix_levenshtein_array.begin(), key_suffix_levenshtein_array.end());
