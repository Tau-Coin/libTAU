...
TORRENT_VERSION_NAMESPACE_3
	...
	// the metadata extension to work, libTAU must be built with extensions
...
#include "libTAU/aux_/disable_warnings_pop.hpp"
		...
		//
		// In earlier versions of libTAU, the URL could be an HTTP or file://
		...
		// communicated forward into libTAU via this field. If this is set, a
