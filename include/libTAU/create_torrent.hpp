...
#include "libTAU/aux_/path.hpp" // for combine_path etc.
...
namespace libTAU {
	...
	struct TORRENT_EXPORT create_torrent
	{
		...
		// be saved off separately and fed into libTAU the first time you start seeding it,
