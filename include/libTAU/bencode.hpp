...
// some messages in the network protocol. libTAU also uses it to store
...
#include "libTAU/aux_/io_bytes.hpp" // for write_string
#include "libTAU/aux_/string_util.hpp" // for is_digit
