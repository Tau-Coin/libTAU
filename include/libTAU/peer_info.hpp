...
TORRENT_VERSION_NAMESPACE_2
	...
	struct TORRENT_EXPORT peer_info
	{
		...
		using peer_flags_t = libTAU::peer_flags_t;
		using peer_source_flags = libTAU::peer_source_flags_t;
#endif
		...
		using connection_type_t = libTAU::connection_type_t;
#endif
