...
namespace std {
	...
	template<typename UnderlyingType, typename Tag>
	class numeric_limits<libTAU::aux::strong_typedef<UnderlyingType, Tag>> : public std::numeric_limits<UnderlyingType>
	{
		using type = libTAU::aux::strong_typedef<UnderlyingType, Tag>;
	public:
	...
	template<typename UnderlyingType, typename Tag>
	struct hash<libTAU::aux::strong_typedef<UnderlyingType, Tag>> : std::hash<UnderlyingType>
	{
		using base = std::hash<UnderlyingType>;
		using result_type = std::size_t;
		result_type operator()(libTAU::aux::strong_typedef<UnderlyingType, Tag> const& s) const
