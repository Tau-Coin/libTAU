...
// OVERVIEW
//
// The disk I/O can be customized in libTAU. In previous versions, the
...
namespace file_open_mode {
	...
	// libTAU disk I/O subsystem. It's associated with a single torrent.
	...
	// The disk_interface is the customization point for disk I/O in libTAU.
	...
	// disk_interface) are called from within libTAU's network thread. For
	...
	// internal libTAU torrent object to tie the storage object allocated
