...
namespace gzip_errors {
	// libTAU uses boost.system's ``error_code`` class to represent errors. libTAU has
...
template<>
struct is_error_code_enum<libTAU::gzip_errors::error_code_enum>
{ static const bool value = true; };

template<>
struct is_error_condition_enum<libTAU::gzip_errors::error_code_enum>
{ static const bool value = true; };
