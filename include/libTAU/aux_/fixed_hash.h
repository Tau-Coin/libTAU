...
public:
    ...
    explicit FixedHash(std::string const& _s, ConstructFromStringType _t = FromHex, ConstructFromHashType _ht = FailIfDifferent): FixedHash(_t == FromHex ? fromHex(_s, WhenError::Throw) : libTAU::aux::asBytes(_s), _ht) {}
...
namespace std
{
    ...
    template<> struct hash<libTAU::aux::h64>: libTAU::aux::h64::hash {};
    template<> struct hash<libTAU::aux::h128>: libTAU::aux::h128::hash {};
    template<> struct hash<libTAU::aux::h160>: libTAU::aux::h160::hash {};
    template<> struct hash<libTAU::aux::h256>: libTAU::aux::h256::hash {};
    template<> struct hash<libTAU::aux::h512>: libTAU::aux::h512::hash {};
}
