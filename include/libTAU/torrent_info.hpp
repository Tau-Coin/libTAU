...
#include "libTAU/aux_/copy_ptr.hpp"
...
TORRENT_VERSION_NAMESPACE_3
	...
	public:
		...
		// metadata will be created by libTAU as soon as it has been
		...
		// string literals. There is an object in the libTAU namespace of this
...
// ------- end deprecation -------
		...
		// libTAU, the merkle tree will be persisted in the resume data.
		TORRENT_DEPRECATED
