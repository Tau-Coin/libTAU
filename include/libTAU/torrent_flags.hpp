...
#include "libTAU/aux_/disable_warnings_push.hpp"
	...
	// If ``seed_mode`` is set, libTAU will assume that all files
	...
	// auto_managed flag set can be started at any time by libTAU's queuing
	// logic. See queuing_.
	...
	// started and seeded automatically by libTAU. When this is set,
